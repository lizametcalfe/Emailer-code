...
count_waitrose_OLD = pd.read_csv('/home/mint/my-data/global_code/KPIs/waitrose/dailycounts.csv')
...
toaddrs = ['rwb0000@gmail.com','lizametcalfe@gmail.com'] #'nigel.swier@ons.gsi.gov.uk','ben.clapperton@ons.gsi.gov.uk','ben.clapperton@hotmail.co.uk',
...
count_sainsbury_OLD = pd.read_csv('/home/mint/my-data/global_code/KPIs/sainsbury/dailycounts.csv')
...
count_tesco_OLD = pd.read_csv('/home/mint/my-data/global_code/KPIs/tesco/dailycounts.csv')
