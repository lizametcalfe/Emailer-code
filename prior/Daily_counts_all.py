...
def update_prices_daily_count(supermarket, the_date):
    ...
    count_supermarketdf_OLD = pd.read_csv('/home/mint/longditudal/output/KPIs/'+supermarket+'/dailycounts.csv')
    ...
    count_supermarketdf_NEW.to_csv('/home/mint/longditudal/output/KPIs/'+supermarket+'/dailycounts.csv') 
    ...
    item_count_supermarketdf_OLD = pd.read_csv('/home/mint/longditudal/output/KPIs/'+supermarket+'/'+supermarket+'_item_counts.csv')
    ...
    item_count_supermarketdf_NEW.ix[:,2:totcol].to_csv('/home/mint/longditudal/output/KPIs/'+supermarket+'/'+supermarket+'_item_counts.csv', index = False)
