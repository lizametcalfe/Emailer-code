...
def  daily_munge(supermarket, date) :  
    ...
    if counter > 0: 
        ...
        try:
            supermarketDF.to_csv('/home/mint/workinprogress/supermarket_scraper/output/'+ supermarket + '/'+ file, index = False)
        ...
        file = '/home/projectt004/Prices/Data/' + supermarket + '_longitudinal.csv'
        ...
        try:
            ...
            if L > 0: 
                ...
                oldfile.to_csv('/nas/projects/ProjectT004/Data/' + supermarket + '_longitudinal_backup.csv', index = False)
