...
def update_prices_daily_count(supermarket, the_date):
    ...
    #OLD
    count_supermarketdf_OLD = pd.read_csv('/home/mint/workinprogress/Global_Code/'+supermarket+'/Outputs/dailycounts.csv')
    ...
    count_supermarketdf_NEW.to_csv('/home/mint/workinprogress/Global_Code/'+supermarket+'/Outputs/dailycounts.csv')
    ...
    item_count_supermarketdf_OLD = pd.read_csv('/home/mint/workinprogress/Global_Code/'+supermarket+'/Outputs/'+supermarket+'_item_counts.csv')
    ...
    item_count_supermarketdf_NEW.ix[:,2:totcol].to_csv('/home/mint/workinprogress/Global_Code'+supermarket+'/Outputs/'+ supermarket + '_item_counts.csv', index = False)
