...
def update_prices_daily_count(supermarket, the_date):
    ...
    print filename
    counter = 0
    for file in os.listdir('/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/my-data/supermarket_scraper/output/'+supermarket+'/'):
        ...
        if fnmatch.fnmatch(file, filename):
            ...
            if counter == 0:
                ...
                file2 = '/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/my-data/supermarket_scraper/output/'+supermarket+'/'+ file
    ...
    #OLD
    count_supermarketdf_OLD = pd.read_csv('/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/my-data/global_code/KPIs/'+supermarket+'/dailycounts.csv')
    count_supermarketdf_OLD.drop_duplicates(take_last=False, inplace=True)
    ...
    count_supermarketdf_NEW.to_csv('/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/my-data/global_code/KPIs/'+supermarket+'/dailycounts.csv')
    ...
    item_count_supermarketdf_OLD = pd.read_csv('/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/my-data/global_code/KPIs/'+supermarket+'/'+supermarket+'_item_counts.csv')
    ...
    item_count_supermarketdf_NEW.ix[:,2:totcol].to_csv('/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/my-data/global_code/KPIs/'+supermarket+'/'+supermarket+'_item_counts.csv', index = False)
